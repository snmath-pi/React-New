...
function App() {
  ...
  return (
    <>
      ...
      <h1>TailWind CSS</h1>
      <Card username='saksham' btnText='Click me'></Card>
      <Card username = 'jiangly' btnText='Visit me'></Card>
      {/* <h1 className='bg-green-400 text-black p-4 rounded-xl'>Tailwind Test</h1>
        <figure class="bg-slate-100 rounded-xl p-8 dark:bg-slate-800">
        <img class="w-24 h-24 rounded-full m" src="https://images.pexels.com/photos/19797338/pexels-photo-19797338/free-photo-of-2024.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" width="384" height="512" />
